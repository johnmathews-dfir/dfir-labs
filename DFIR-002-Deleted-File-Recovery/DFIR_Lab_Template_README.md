...
- Commands are curated → not a transcript
- Separate thinking from evidence at all times
...
If time or energy is limited, a lab is considered complete if it includes:
